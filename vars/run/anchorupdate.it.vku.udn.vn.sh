...
jq '.channel_group.groups.Application.groups."it-vku-udn-vn".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.93.168","port": 7002}]},"version": "0"}}' vku_current_config.json > vku_modified_anchor_config.json
