...
jq '.channel_group.groups.Application.groups."it-vku-udn-vn".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "172.30.127.73","port": 7003}]},"version": "0"}}' vku_current_config.json > vku_modified_anchor_config.json
